  ...
  return (
    <div className="hero-bg relative">
        ...
        <header className="max-w-6xl mx-auto flex items-center justify-between p-4 pb-10">
            <img src="catflix-logo.png" alt='Catflix Logo' className="w-32 md:2-52" />
        ...
        <div className="flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto">
            ...
            <p className="text-lg mb-4">Watch anywhere, anytime for free</p>
            <p className="mb-4">Enter your email and make a meow account today!</p>
            ...
            />
            <button className="bg-red-600 text-xl lg:text-2xl px-2 lg:px- py-1 md:py-2 rounded flex justify-center items-center">
                Get Started
            ...
            <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse px-4 md:px-2">
                ...
                <div className="flex-1">
                    <div className="relative">
                        ...
                        className="mt-4"
                        />
                        <div className="flex items-center gap2 absolute bottom-5 left-1/2 -translate-x-1/2 bg-black 
        ...
        <div className="py-10 bg-black text-white">
            <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2">
                ...
                <div className="flex-1 text-center md:text-left">
                    ...
                    <p className="text-lg md:text-xl">
                        Stream unlimited moveis and tv shows on your phone, tablet, laptop, and TV. 
                    </p>
                </div>
                { /* right side */}
                <div className="flex-1 relative">
